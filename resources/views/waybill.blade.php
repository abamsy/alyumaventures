...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body> 
        ...
        <div>
            <img src = "http://s3.amazonaws.com/alyumaventures/AL-YUMA LOGO.png" alt="" style="height:2.8cm; padding-left:1cm;">
            <img src = "http://s3.amazonaws.com/alyumaventures/COAT_OF_ARMS.png" alt="" style="width:3cm; margin-bottom:0.3cm; padding-left:1cm;">
        </div>
        ...
        <h4 style="font-family: Arial, Helvetica, sans-serif;"><span style="padding-left:11cm;">Driver Phone: {{ $waybill->phone }}</span><br\></h4>
        </div>
