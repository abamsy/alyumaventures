    ...
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            ...
            <x-jet-dialog-modal wire:model="modalVisibility">
                @if($modelId)
                <x-slot name="title">
                    {{ __('Edit Blending Plant') }}
                </x-slot>
                @else
                <x-slot name="title">
                    {{ __('Create Blending Plant') }}
                </x-slot>
                @endif
                ...
                <x-slot name="content">
                    ...
                    <div class="mt-4">
                        ...
                        <x-jet-input id="contact_person" class="block mt-1 w-full" type="text" wire:model.debounce.800ms="contact_person" />
            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                ...
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ $plant->contact_person }}</div>
                            <div class="text-sm text-gray-500">{{ $plant->phone }}</div>
                        </td>
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="px-6 py-4 whitespace-nowrap">No blending plant found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                    </table>
